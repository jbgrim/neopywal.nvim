...
%s]],
    ...
    os.execute('echo "transparent_background_colors ' .. extra_bg .. "@0.85 " .. cursor .. "@0.85 " .. bg1 .. "@0.85 " .. bg2 .. "@0.85 " .. bg3 .. "@0.85 " .. C.background .. '@0.85" > ~/.cache/wal/transparent_bg_kitty.conf')
